...
\begin{figure}[htpb]
	...
	% Text Node
	\draw (361,50.4) node [anchor=north west][inner sep=0.75pt]    {$\mathbf{\nu }$};
...
dove $\displaystyle \gamma  >0$ è una costante di proporzionalità e $\displaystyle U$ è la temperatura ambiente. Ponendo $\displaystyle \alpha =\frac{\gamma }{k}  >0$ e $\displaystyle \beta =\frac{}{}\frac{\gamma U}{k}$ posso riscrivere la condizione:\begin{equation*}
...
Il nostro modello discreto, dato un passo spaziale di lunghezza $\displaystyle h$ e un intervallo temporale di durata $\displaystyle \tau $, prevede \textbf{una} particella di \textbf{massa unitaria} in moto lungo un asse (asse $\displaystyle x$) con le seguenti regole
\begin{enumerate}
...
\begin{itemize}
\item $\displaystyle k$ passi a destra ($k$ è una variabile aleatoria)
...
\begin{dimostrazione}
	...
	\end{equation*}
	Voglio dimostrare che $\displaystyle g( r)$ è costante e quindi che $\displaystyle g'( r) =0$ per $\displaystyle 0< r< R$. Effettuo un cambio di variabili $\displaystyle \bm{\sigma } '=\frac{\bm{\sigma } -\x}{r}$, ovvero $\displaystyle \bm{\sigma } =\x +r\bm{\sigma } '$, in modo dale che $\displaystyle \bm{\sigma } '\in \partial B_{1}(\mathbf{0})$ e
	\begin{equation*}
	...
	\begin{figure}[H]
		...
		% Text Node
		\draw (125.33,154.73) node [anchor=north west][inner sep=0.75pt]    {$\mathbf{0}$};
		% Text Node
		...
		% Text Node
		\draw (97,68.4) node [anchor=north west][inner sep=0.75pt]    {$B_{r}(\mathbf{0})$};
		% Text Node
...
p_{1}\\
p_{2}
\end{pmatrix}$ il centro del cerchio, con $\bm{\sigma } =\begin{pmatrix}
p_{1} +R\cos \varphi \\
p_{2} +R\sin \varphi 
...
\begin{theorem}
	...
	\begin{equation*}
		u(x) =\underbrace{-\int _{\Omega } \Phi (x-y) \Delta f(y) dy}_{ \begin{array}{l}
...
\begin{dimostrazione}
	...
	\begin{equation*}
	\int _{\Omega }( v\Delta u-u\Delta v) d\mathbf{x} =\int _{\partial \Omega }( v\partial _{\mathbf{\nu }} u-u\partial _{\mathbf{\nu }} v) d\bm{\sigma }
	\end{equation*}
	Applichiamo l'identità di Green utilizzando come funzione $\displaystyle u$ la stessa dell'enunciato del teorema. Per la funzione $\displaystyle v$ dobbiamo trovare un'alternativa, infatti, con $\displaystyle \mathbf{x}$ fissato
	\begin{equation*}
	v(\mathbf{y}) =\Phi (\mathbf{x} -\mathbf{y}) =\frac{1}{4\pi }\frac{1}{| \mathbf{x} -\mathbf{y}| } \notin C^{2}( \Omega )
	\end{equation*}
	Con $\displaystyle \Omega $ dominio limitato, definisco 
	\begin{equation*}
	\Omega _{\varepsilon } =\Omega \setminus \overline{B}_{\varepsilon }(\mathbf{x})
	\end{equation*}
	\begin{figure}[H]
		\centering
		\tikzset{every picture/.style={line width=0.75pt}} %set default line width to 0.75pt        
	...
	In $\displaystyle \Omega _{\varepsilon }$, $\displaystyle v(\mathbf{y}) \in C^{2}\left(\overline{\Omega _{\varepsilon }}\right)$ e inoltre $\displaystyle \Delta v=0$ in $\displaystyle \Omega _{\varepsilon }$.
	...
	\begin{equation*}
	\frac{1}{4\pi }\underbrace{\int _{\Omega _{\varepsilon }}\frac{1}{| \mathbf{x} -\mathbf{y}| } f(\mathbf{y}) d\mathbf{y}}_{( 1)} =\frac{1}{4\pi }\underbrace{\int _{\partial \Omega _{\varepsilon }}\frac{1}{| \mathbf{x} -\bm{\sigma }| } \partial _{\mathbf{\nu }} u(\bm{\sigma }) d\bm{\sigma }}_{( 2)} -\frac{1}{4\pi }\underbrace{\int _{\partial \Omega _{\varepsilon }} u(\bm{\sigma }) \partial _{\mathbf{\nu }}\frac{1}{| \mathbf{x} -\bm{\sigma }| } d\bm{\sigma }}_{( 3)}
	\end{equation*}
	Inoltre
	\begin{equation*}
	\partial \Omega _{\varepsilon } =\partial \Omega \cup \partial B_{\varepsilon }(\mathbf{x})
	\end{equation*}
	E su $\displaystyle \partial B_{\varepsilon }(\mathbf{x})$
	\begin{equation*}
	\mathbf{\nu }(\bm{\sigma }) =\frac{\mathbf{x} -\bm{\sigma }}{| \mathbf{x} -\bm{\sigma }| } =\frac{\mathbf{x} -\bm{\sigma }}{\varepsilon }
	\end{equation*}
	...
	\begin{equation*}
	( 1) =\int _{\Omega _{\varepsilon }}\frac{1}{| \mathbf{x} -\mathbf{y}| } f(\mathbf{y}) d\mathbf{y} =\int _{\Omega }\underbrace{\chi _{\Omega _{\varepsilon }}(\mathbf{y})\frac{f(\mathbf{y})}{| \mathbf{x} -\mathbf{y}| }}_{g_{\varepsilon }(\mathbf{y})} d\mathbf{y}
	\end{equation*}

	Con 

	\begin{equation*}
	| g_{\varepsilon }(\mathbf{y})| \leqslant \max\frac{| f| }{| \mathbf{x} -\mathbf{y}| }
	\end{equation*}

	Posso usare il teorema di convergenza dominata e passare al limite sotto il segno di integrale, il primo termine tende a

	\begin{equation*}
	( 1)\rightarrow \int _{\Omega }\frac{1}{| \mathbf{x} -\mathbf{y}| } f(\mathbf{y}) d\mathbf{y}
	\end{equation*}
	...
	\begin{equation*}
	\int _{\partial \Omega _{\varepsilon }}\frac{\partial _{\mathbf{\nu }} u(\bm{\sigma })}{| \mathbf{x} -\bm{\sigma }| } d\bm{\sigma } =\left(\int _{\partial \Omega } +\int _{\partial B_{\varepsilon }( x)}\right)\frac{\partial _{\mathbf{\nu }} u(\bm{\sigma })}{| \mathbf{x} -\bm{\sigma }| } d\bm{\sigma }
	\end{equation*}
	...
	\begin{equation*}
	| \partial _{\mathbf{\nu }} u(\bm{\sigma })| =| \nabla u(\bm{\sigma }) \cdotp \mathbf{\nu }| \leqslant \max| \nabla u| 
	\end{equation*}

	maggioriamo\begin{align*}
	\left| \int _{\partial B_{\varepsilon }(\mathbf{x})}\frac{\partial _{\mathbf{\nu }} u(\bm{\sigma })}{| \mathbf{x} -\bm{\sigma }| } d\bm{\sigma }\right|  & \leqslant \int _{\partial B_{\varepsilon }(\mathbf{x})}\frac{| \partial _{\mathbf{\nu }} u(\bm{\sigma })| }{\underbrace{| \mathbf{x} -\bm{\sigma }| }_{=\varepsilon }} d\bm{\sigma }\\
	 & \leqslant \frac{1}{\varepsilon }\int _{\partial B_{\varepsilon }(\mathbf{x})}\max| \nabla u| d\bm{\sigma }\\
	 & =\frac{\max| \nabla u| }{\varepsilon }\int _{\partial B_{\varepsilon }(\mathbf{x})} d\bm{\sigma }\\
	...
	( 2)\rightarrow \int _{\partial \Omega }\frac{\partial _{\mathbf{\nu }} u(\bm{\sigma })}{| \mathbf{x} -\bm{\sigma }| } d\bm{\sigma }
	\end{equation*}
	...
	\begin{equation*}
	( 3) =\int _{\partial \Omega _{\varepsilon }} u(\bm{\sigma }) \partial _{\mathbf{\nu }}\frac{1}{| \mathbf{x} -\bm{\sigma }| } d\bm{\sigma } =\left(\int _{\partial \Omega } +\int _{\partial B_{\varepsilon }(\mathbf{x})}\right) u(\bm{\sigma }) \partial _{\mathbf{\nu }}\frac{1}{| \mathbf{x} -\bm{\sigma }| } d\bm{\sigma }
	\end{equation*}

	L'integrale su $\displaystyle \partial \Omega $ è già il potenziale di doppio strato, ci manca da far vedere che l'altro tende a $\displaystyle u$, a meno del coefficiente. Calcolo la derivata normale su $\displaystyle \partial B_{\varepsilon }(\mathbf{x})$ con la regola della catena\begin{equation*}
	\nabla _{\bm{\sigma }}\frac{1}{| \mathbf{x} -\bm{\sigma }| } =-\frac{1}{| \mathbf{x} -\bm{\sigma }| ^{2}} \cdotp \frac{\mathbf{x} -\bm{\sigma }}{| \mathbf{x} -\bm{\sigma }| }( -1) =\frac{\mathbf{x} -\bm{\sigma }}{| \mathbf{x} -\bm{\sigma }| ^{3}} =\frac{\mathbf{x} -\bm{\sigma }}{\varepsilon ^{3}}
	\end{equation*}

	quindi\begin{equation*}
	\partial _{\mathbf{\nu }}\frac{1}{| \mathbf{x} -\bm{\sigma }| } =\nabla \frac{1}{| \mathbf{x} -\bm{\sigma }| } \cdotp \mathbf{\nu } =\frac{\mathbf{x} -\bm{\sigma }}{\varepsilon ^{3}} \cdotp \frac{\mathbf{x} -\bm{\sigma }}{\varepsilon } =\frac{1}{\varepsilon ^{2}}
	\end{equation*}

	Da cui\begin{align*}
	\int _{\partial B_{\varepsilon }(\mathbf{x})} u(\bm{\sigma }) \partial _{\mathbf{\nu }}\frac{1}{| \mathbf{x} -\bm{\sigma }| } d\bm{\sigma } & =\frac{1}{\varepsilon ^{2}}\int _{\partial B_{\varepsilon }(\mathbf{x})} u(\bm{\sigma }) d\bm{\sigma }\\
	 & =\frac{4\pi \varepsilon ^{2}}{\varepsilon ^{2}} \cdotp \underbrace{\frac{1}{4\pi \varepsilon ^{2}}\int _{\partial B_{\varepsilon }(\mathbf{x})} u(\bm{\sigma }) d\bm{\sigma }}_{\rightarrow u(\mathbf{x})}\rightarrow 4\pi u(\mathbf{x})
	\end{align*}

	quindi\begin{equation*}
	( 3)\rightarrow \int _{\partial \Omega } u(\bm{\sigma }) \partial _{\mathbf{\nu }}\frac{1}{| \mathbf{x} -\bm{\sigma }| } d\bm{\sigma } +4\pi u(\mathbf{x})
	\end{equation*}
...
\begin{itemize}
	...
	Fissato $\displaystyle t$, posso avere $\displaystyle u_{R} < u_{L}$ e $\displaystyle q$ convessa $(q''>0)$
	...
	oppure $\displaystyle u_{R}  >u_{L}$ e $\displaystyle q$ concava $(q''<0)$
...
\begin{enumerate}
	...
	\item Lo spostamento verticale $\displaystyle u$ di un punto dipende solo dalla sua posizione sulla corda $x$ e dal tempo $t$. Quindi\begin{equation*}
	      u=u( x,t)
	\end{equation*}
...
\end{equation*}
L'equazione del bilancio del momento si ricava uguagliando la forza totale agente sul generico tratto considerato al tasso di variazione del momento lineare. Poiché il moto è verticale, le componenti orizzontali delle forze devono bilanciarsi: $R_{x}=0$. Indicando con $\displaystyle \tau ( x,t)$ la tensione (scalare, ma non adimensionale) in $\displaystyle x$
...
\end{equation*}
Quindi il lavoro compiuto da tali forze elastiche\footnote{Stiamo trattando piccole vibrazioni, $\displaystyle \tau $ non dipende da $\displaystyle x$.} è
\begin{equation*}
...
\begin{enumerate}
	\item Il (PCG) \eqref{eq:onde-pcg-1d} ha un'\textbf{unica} soluzione \textit{regolare} data da \eqref{eq:onde-formula-di-dAlembert}. Notiamo che deve essere:
		\begin{equation*}
...
\begin{dimostrazione}
	...
	\begin{itemize}
		\item Caso di condizioni di Neumann/Dirichlet/misti.
		      ...
		      \end{equation*}Siccome siamo con \textbf{condizioni inizial nulle}:
		      \begin{equation*}
		      	\begin{cases}
...
\end{oss}
\begin{theorem}
	[Lemma A] In dimensione $\displaystyle n$ generica, sia $\displaystyle w_{h}$ la soluzione di
	\begin{equation*}
	\begin{cases}
	w_{tt} v-c^{2} \Delta w=0 & \mathbf{x} \in \mathbb{R}^{n} ,t >0\\
	w(\mathbf{x} ,0) =0 & \mathbf{x} \in \mathbb{R}^{n}\\
	w_{t}(\mathbf{x} ,0) =h(\mathbf{x}) & \mathbf{x} \in \mathbb{R}^{n}
	\end{cases}
	\end{equation*}
	se $\displaystyle w_{g}$ è sufficientemente regolare (qui ad esempio basta $\displaystyle C^{3}$) allora
	\begin{equation*}
	v=\partial _{t} w_{g}
	\end{equation*}
	è soluzione di:
	\begin{equation*}
	\begin{cases}
	\partial _{tt} v-c^{2} \Delta v=0 & \mathbf{x} \in \mathbb{R}^{n} ,t >0\\
	v(\mathbf{x} ,0) =g(\mathbf{x}) & \mathbf{x} \in \mathbb{R}^{n}\\
	v_{t}(\mathbf{x} ,0) =0 & \mathbf{x} \in \mathbb{R}^{n}
	\end{cases}
	\end{equation*}
	Come corollario, essendo il problema \textbf{omogeneo} possiamo sommare le soluzioni. La soluzione di (PCG) è data da:
	\begin{align*}
	u & =v+w_{h}\\
...
\begin{dimostrazione}
	...
	\begin{align*}
		v(\mathbf{x} ,0) & =\partial _{t} w_{g}(\mathbf{x} ,0) =g(\mathbf{x}) ,\\
	v_{t}(\mathbf{x} ,0) & =\partial _{tt} w_{g}(\mathbf{x} ,0) =c^{2} \Delta \underbrace{w_{g}(\mathbf{x} ,0)}_{=0} =0.
	\end{align*}
\end{dimostrazione}
Di conseguenza, per risolvere il problema di Cauchy globale, mi basta risolverlo con $\displaystyle g=0$ e $\displaystyle h$ qualunque, per poi costruire la soluzione come appena visto.
...
\begin{dimostrazione}
	...
	\begin{align*}
		...
		\textcolor[rgb]{0.82,0.01,0.11}{\frac{ct}{4\pi }}\textcolor[rgb]{0.82,0.01,0.11}{\int _{\partial B_{1}(\mathbf{0})}}\textcolor[rgb]{0.82,0.01,0.11}{\nabla h}\textcolor[rgb]{0.82,0.01,0.11}{(}\textcolor[rgb]{0.82,0.01,0.11}{\mathbf{x}}\textcolor[rgb]{0.82,0.01,0.11}{+ct}\textcolor[rgb]{0.82,0.01,0.11}{\mathbf{w}}\textcolor[rgb]{0.82,0.01,0.11}{)}\textcolor[rgb]{0.82,0.01,0.11}{\cdotp }\textcolor[rgb]{0.82,0.01,0.11}{\mathbf{w}}\textcolor[rgb]{0.82,0.01,0.11}{d}\textcolor[rgb]{0.82,0.01,0.11}{\mathbf{w}} & =\frac{1}{4\pi ct}\int _{\partial B_{1}(\mathbf{0})}\underbrace{\nabla h(\mathbf{x} +ct\mathbf{w})}_{\nabla h(\mathbf{x} +ct\mathbf{w}) =\nabla h(\mathbf{\sigma })} \cdotp \mathbf{w}\underbrace{c^{2} t^{2} d\mathbf{w}}_{d\mathbf{\sigma }} & \\
	 	& =\frac{1}{4\pi ct}\int _{\partial B_{ct}(\mathbf{x})} \nabla h(\mathbf{\sigma }) \cdotp \mathbf{\nu } \ d\mathbf{\sigma } & \\
	 	& =\frac{1}{4\pi ct}\int _{B_{ct}(\mathbf{x})} \Delta h(\mathbf{y}) d\mathbf{y} & \text{(Teo. divergenza)}\\
	 	& =\frac{1}{4\pi ct}\int _{0}^{ct} dr\int _{\partial B_{r}} \Delta h(\mathbf{\sigma }) d\mathbf{\sigma } , & \text{(coord. polari)}
	\end{align*}
	quindi:
	\begin{equation*}
		\partial _{tt} w_{h}(\mathbf{x} ,t) =\cancel{\frac{c}{4\pi }\int _{\partial B_{1}(\mathbf{0})} \nabla h(\mathbf{x} +ct\mathbf{w}) \cdotp \mathbf{w} d\mathbf{w}} -\cancel{\frac{1}{4\pi ct^{2}}\int _{B_{ct}(\mathbf{x})} \Delta h(\mathbf{y}) d\mathbf{y}} +\frac{\cancel{c}}{4\pi \cancel{c} t}\int _{\partial B_{ct}(\mathbf{x})} \Delta h(\mathbf{\sigma }) d\mathbf{\sigma } ,
	\end{equation*}
	i primi due termini sono uguali (si vede svolgendo i passaggi di prima per tornare indietro), pertanto:
	\begin{equation*}
		\partial _{tt} w_{h}(\mathbf{x} ,t) =\frac{1}{4\pi t}\int _{\partial B_{ct}(\mathbf{x})} \Delta h(\mathbf{\sigma }) d\mathbf{\sigma } .
	\end{equation*}
