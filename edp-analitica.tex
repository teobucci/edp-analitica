...
% d nell'integrale con vettoriale
\newcommand{\dxx}{\de \x}
\newcommand{\dyy}{\de \y}
...
\begin{equation*}
\int _{\Omega }\mathrm{div}\mathbf{G}\ \dx=\int _{\partial \Omega }\mathbf{G} \cdotp \nuu\ \dsig \qquad \text{dove}\ \nuu\ \text{è il versore normale.}
\end{equation*}
...
\begin{equation}
	\boxed{\int _{\Omega } v\ \mathrm{div}(\mathbf{F}) = \int _{\partial \Omega } v\mathbf{F} \cdotp \nuu \ \dsig -\int _{\Omega } \nabla v\cdotp \mathbf{F}}
\end{equation}
...
\begin{equation}
	\boxed{\int _{\Omega } v\Delta u\ \dx= \int _{\partial \Omega } v\partial _{\nuu} u\ \dsig - \int _{\Omega } \nabla v\cdotp \nabla u}
	\label{eq:id-green}
\end{equation}
In particolare se $v=1$
\begin{equation}
\int _{\Omega } \Delta u\ \dx=\int _{\partial \Omega } \partial _{\nuu} u\ \dsig 
...
Mettendo insieme
\begin{equation*}
\frac{\de}{\dt}\int _{V} e\rho \dx=\int _{V} r\rho \dx-\int _{\partial V}\mathbf{q} \cdotp \nuu \ \dsig 
\end{equation*}
...
\begin{equation}
\boxed{\int _{\Omega } f+\int _{\partial \Omega } g\dsig =0}
\end{equation}
Per esempio:
\begin{equation*}
	\begin{cases}
...
\begin{dimostrazione}
	...
	\begin{align*}
		0 & =\int _{\Omega }\mathrm{div}\mathbf{F} \ \dxx =\int _{\Omega }\mathrm{div}\left( \varphi ^{2}(\x)\x\right) \ \dxx                                              \\
		  & =\int _{\Omega }\left[\underbrace{2\varphi \nabla \varphi }_{\nabla \left( \varphi ^{2}\right)} \cdotp \x +\varphi ^{2}\underbrace{\mathrm{div}\x}_{=n}\right] \dxx , 
	\end{align*}
