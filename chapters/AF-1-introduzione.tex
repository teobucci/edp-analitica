...
\begin{dimostrazione}
    ...
    \begin{itemize}
        \item Esistenza
              ...
              dove l'ultima disuguaglianza vale perché $\Vert v-x\Vert \geq d,\ \forall v\in V$ (definizione di $\inf$) e $\displaystyle \frac{v_{n} +v_{m}}{2} \in V$, essendo $V$ un sottospazio.
        ...
        \item Inoltre (punto 2)\\
              ...
              quindi:
              \begin{align*}
                  d^{2} & \leq \Vert -(P_{V} x-tv) +x\Vert ^{2} =\Vert Q_{V} x+tv\Vert ^{2} \\
              ...
              otteniamo che:
              \begin{equation*}
                  \Vert v\Vert ^{2} t^{2} +2(Q_{V} x,v) t\geq 0,\ \forall t\in \mathbb{R},\ \forall v\in V
              \end{equation*}
              Per analogia con l'equazione di una parabola a discriminante non positivo:
              \begin{equation*}
                  at^{2} +bt+c\geq 0,\ \forall t\in \mathbb{R} \ \ \Rightarrow \ \ b^{2} -4ac\leq 0
              \end{equation*}
...
\end{nb}
\begin{definition}
    [Operatore limitato] $L$ (lineare) si dice limitato se $\displaystyle \exists c\geq 0$ t.c. $\displaystyle \Vert Lv\Vert _{H_{2}} \leq c\Vert v\Vert _{H_{1}} \forall v\in H_{1}$
\end{definition}
Osserviamo che
\begin{equation*}
    c\geq \frac{\Vert Lv\Vert _{H_{2}}}{\Vert v\Vert _{H_{1}}} =\left\Vert \frac{1}{\Vert v\Vert _{1}} Lv\right\Vert _{2} =\left\Vert L\left(\frac{v}{\Vert v\Vert _{1}}\right)\right\Vert _{2}
\end{equation*}
...
\begin{theorem}
    ...
    \begin{equation*}
        \Vert \overline{u}\Vert \leq \frac{1}{\alpha }\Vert L\Vert _{*}
    \end{equation*}
...
\begin{oss}
    ...
    \begin{equation*}
        \Vert u_{1} -u_{2}\Vert \leq \frac{1}{\alpha }\Vert L_{1} -L_{2}\Vert _{*}
    \end{equation*}
