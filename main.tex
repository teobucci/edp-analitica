...
\include{1-modelli-matematici}
\include{2-diffusione}
\include{3-eq-laplace-poisson}
\include{4-leggi-conservazione}
\include{5-onde}

\part{Analisi Funzionale}

\include{AF-1-introduzione}
\include{AF-2-distribuzioni-spazi-sobolev}
\include{AF-3-formulazione-variazionale-poisson}
